                    ...
                    {prestamos.map((prestamo) => (
                        <Grid item xs={12} sm={6} md={4} key={prestamo.id}>
                            <Paper sx={{ padding: 2, display: 'flex', flexDirection: 'column', height: '100%' }}>
                                ...
                                <Typography variant="body1">
                                    <strong>Usuario:</strong> {prestamo.usuario.username}  {/* Asegúrate de que 'username' sea la propiedad correcta */}
                                    </Typography>
                                    <Typography variant="body1">
                                    <strong>Libro:</strong> {prestamo.libro.titulo}  {/* Asegúrate de que 'titulo' sea la propiedad correcta */}
                                    </Typography>
                                <Typography variant="body1">
